...
if __name__ == "__main__":
    ...
    # categories = ["psyllium-nutritional-supplement", "countertop-burners", "flip-phones", "weight-gainers", "pain-relief-homeopathic-remedies", "window-roller-shades", "handheld-flashlights", "gas-detectors-alarms", "windshield-glass-repair-tools", "safety-earmuffs", "home-office-desks", "body-repair-grinders-polishers", "leather-care", "cabinet-safes", "freezer", "craft-shears", "styluses", "ear-care", "washing-machine-cleaners", "humidors", "bread-machines", "battery-packs", "windshield-wiper-blades", "bed-wedges-body-positioners", "energy-drinks", "pc-game-headsets", "home-digital-pianos", "under-cabinet-lights", "drawing-pencils", "espresso-maker", "uninterruptible-power-supply-ups", "small-smartphones", "kids-bikes", "electric-water-heater", "ukuleles", "12v-batteries", "battery-mower", "whole-home-mesh-wi-fi-systems", "pillows", "rolling-walkers", "tv-mounts", "wood-polish-care", "truck-tonneau-covers", "boys-wrist-watches", "skateboards", "hair-scalp-treatments", "red-yeast-rice-herbal-supplements", "kids-electric-vehicles", "inverter-generators", "lens-attachments", "denture-care", "dog-wireless-fences", "electric-kettles", "bike-helmets", "power-pole-saws", "chlorophyll-herbal-supplements", "wifi-routers", "mushrooms-herbal-supplements", "clock-radios", "gps-trackers", "dog-flea-sprays", "pedometers", "mens-military-tactical-boots", "aquarium-filters", "power-drill-drivers", "travel-duffels", "electrical-light-switches", "showerhead", "shapewear", "clitoral-vibrators", "antioxidant-combination-nutritional-supplements", "window-films", "sculpture-molding-casting-products", "care-corrosion-rust-inhibitors", "soft-baby-carriers", "cold-flu-medicine", "cell-phone-battery-charger-cases", "desk-lamps", "borescopes", "electric-fireplaces", "pull-up-bars", "laser-printers", "powersports-speaker-systems", "whey-protein-powders", "sports-nutrition-hydration-products", "rowers", "facial-masks", "bluetooth-car-kits", "hair-sprays", "juicer", "protein-shakes", "womens-water-shoes", "calcium-mineral-supplements", "work-safety-boots", "griddles", "antifungal-remedies", "life-jackets-vests", "vitamin-b8-inositol-supplements", "mens-golf-shoes", "in-refrigerator-water-filters", "hand-mixer", "multi-testers", "scar-reducing-treatments", "diaper-bags", "led-strip-lights", "home-theater-systems"]
    ...
    # categories = ["mens-baseball-caps", "mens-costumes", "mens-sweatshirts", "mouthwash", "neon-signs", "nursery-pillows", "nursery-receiving-blankets", "on-camera-video-lights", "outdoor-doormats", "outdoor-nativity-scenes", "packaged-noodle-soups", "paint-pens-markers", "panty-liners", "parenting-family-reference-books", "self-help-books", "playard-bedding", "plush-figure-toys", "plush-toys-for-dogs", "pocket-knives-folding-knives", "popcorn-poppers", "pork-rinds", "portable-crib-mattresses", "poster-frames", "posters-prints", "powdered-soft-drink-mixes", "protective-shields", "remote-controls", "rice-cookers", "roasting-pans", "safety-work-gloves", "school-safety-books", "sculpture-wire-armatures", "selenium-mineral-supplements", "selfie-sticks-tripods", "single-serve-coffee-capsules-pods", "slot-cars", "snack-trail-mixes", "soap-making-bases-melts", "soccer-balls", "sociology-of-class-books", "soda-maker-parts-accessories", "soda-soft-drinks", "sparkling-juice-drinks", "sports-action-video-cameras", "sports-drinking-water", "sports-drinks", "sports-nutrition-pea-protein-powders", "sports-nutrition-pre-workout-powders", "sports-nutrition-protein-bars", "stage-laser-lights", "stage-lights", "standard-game-dice", "streaming-media-players", "stuffed-animals-teddy-bears", "success-self-help-books", "bird-food", "table-runners", "tablecloths", "tactical-knives", "telephone-headsets", "throw-pillow-covers", "timers", "toilet-paper", "toy-construction-tools", "toy-gardening-equipment", "tumblers-water-glasses", "unfinished-wood", "vase-fillers", "votive-candles", "timer-switches", "windshield-de-icers", "womens-bikini-panties", "body-sprays", "womens-costumes", "womens-domestic-life-fiction-books", "womens-fashion-hoodies-sweatshirts", "womens-fragrances", "womens-jeans", "womens-novelty-one-piece-pajamas", "womens-novelty-sweatshirts", "womens-novelty-t-shirts", "womens-casual-skirts", "yarn", "yoga-mats"]

    # categories = ["activity-fitness-trackers", "appetite-control-suppressants", "b7-biotin-supplements", "battery-chargers", "binoculars", "blended-vitamin-mineral-supplements", "camping-tents", "car-in-dash-navigation-gps-units", "car-stereo-receivers", "chainsaws", "chemical-drain-openers", "code-readers-scan-tools", "collagen-supplements", "compact-washers", "computer-monitors", "cookware-sets-nonstick", "countertop-microwave-oven", "dehumidifier", "dildos", "dog-flea-drops", "dog-itch-remedies", "dog-relaxants", "dogs-herbal-supplements", "dslr-cameras", "exercise-bike", "game-trail-cameras", "hair-clippers", "hair-dryers-accessories", "hair-regrowth-treatments", "handheld-showerheads", "hemorrhoid-care", "hidden-cameras", "hoses", "household-tower-fans", "jump-starters", "light-hair-removal-devices", "magnesium-mineral-supplements", "mens-hiking-shoes", "mens-sunglasses", "metal-detectors", "micro-sd-memory-cards", "monoculars", "mp3-mp4-players", "multivitamins", "on-dash-cameras", "portable-air-conditioners", "probiotic-nutritional-supplements", "projectors", "shoe-insoles", "signal-boosters", "sonic-repellents", "sound-bars", "stand-up-paddleboards", "string-trimmers", "teeth-whitening", "treadmill", "tv-antennas", "usb-flash-drives", "vaginal-moisturizers", "vehicle-backup-cameras", "vitamins-dietary-supplements", "wart-removal", "wi-fi-extenders", "wireless-security-cameras", "food-processor", "baby-stationary-activity-centers", "womens-foil-shavers", "tongue-and-groove-pliers", "motorcycle-goggles", "ammunition-magazine-pouches", "mens-henley-shirts", "fat-burners", "kids-crayons", "nail-growth-products", "motor-oils", "womens-fashion-backpacks"]

    # categories = ['wireless-security-cameras', 'food-processor', 'baby-stationary-activity-centers', 'womens-foil-shavers', 'tongue-and-groove-pliers', 'motorcycle-goggles', 'ammunition-magazine-pouches', 'mens-henley-shirts', 'fat-burners', 'kids-crayons', 'nail-growth-products', 'motor-oils', 'womens-fashion-backpacks']
